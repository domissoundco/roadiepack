        ...
        {(() => {
          return (
            <div style={{
              ...
              {/* Outfit items — tap to confirm you're wearing it */}
                  ...
                  return (
                    <div key={i}
                      ...
                      style={{
                        ...
                        background: isWorn ? t.accentLight : "transparent",
                        border: `1px solid ${isWorn ? t.accent : t.border}`,
                      ...
                      {item.wears && (
                        <div style={{
                          ...
                          {isWorn && <span style={{ color: "#fff", fontSize: 10, fontWeight: 700 }}>✓</span>}
                        </div>
                      )}
                      <span style={{ fontSize: 16, flexShrink: 0 }}>{item.emoji}</span>
                      <span style={{ fontSize: 14, color: t.text, flex: 1 }}>{item.item}</span>
                      {isWorn && (
                        <span style={{ fontFamily: "system-ui, sans-serif", fontSize: 10, color: t.accent, letterSpacing: "0.3px" }}>
                          not in bag
                        </span>
                      )}
                    </div>
